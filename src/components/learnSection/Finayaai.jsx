            ...
            >
              ...
              <div className="space-y-3 w-full">
                {category.items.map((item, i) => (
                  <button
                    key={i}
                    className="w-full bg-white/10 hover:bg-white/25 active:scale-[0.98] transition-all text-white/90 text-sm p-2 rounded-xl text-left leading-relaxed border border-white/5"
                  >
                    "{item}"
                  </button>
                ))}
      ...
      <div className="bg-[#e0eeed] py-4 px-3 sm:px-6 rounded-b-2xl">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-2xl px-2 py-2 flex items-center gap-2 sm:gap-3 shadow-2xl">
            ...
            <button
              type="button"
              className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-black shrink-0"
            >
            ...
            <input
              ...
              className="flex-1 min-w-0 bg-transparent border-none focus:ring-0 outline-none text-gray-800 placeholder:text-gray-400 px-2 py-2 text-[16px]"
            />

            <button
              type="button"
              onClick={handleSend}
              className="p-2 sm:px-3 sm:py-2 bg-brand/10 text-brand hover:bg-brand hover:text-white rounded-xl transition-all shrink-0"
            >

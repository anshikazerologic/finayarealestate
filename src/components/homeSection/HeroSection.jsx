      ...
      <div className="container-custom relative z-10 p-5 md:p-10 lg:p-20">
        <div className="max-w-3xl">
          <h1 
            ...
            className="text-5xl md:text-7xl font-inter  text-white leading-[1.1] mb-6"
          >
            Buy Your Dream <br />
            Without <span className="italic font-medium font-inter">Hassle.</span>
          </h1>
          ...
          <p 
            ...
            className="text-lg md:text-3xl text-white font-inter font-normal max-w-lg mb-6"
          >
          ...
          >
            ...
            <div className="w-full md:w-75 space-y-2">
              ...
              <div className="relative">
                <select className="w-full  bg-white/10 border border-white/20 rounded-full mt-2  py-3.5 px-7 text-white appearance-none outline-2 outline-white transition-all">
            ...
            <button className="w-full md:w-auto bg-white text-teal-700 font-bold py-3.5 px-8 rounded-full flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors shadow-lg">
